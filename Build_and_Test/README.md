...
| PIN_40 seems shorted to PIN_41. Output on PIN_41 was also observed on PIN_40.  It as confirmed that output enable function of PIN_40 was not activated. No PCB faults could be found and this was verified by "lifting" PIN_40 from the solder pad and measuring it in iscolation - still had same output as PIN_41.  Resistance between PIN_40 and PIN_41 measured as ~240 ohm. | Not sure why this is occuring.  May be good to break out PIB-40 separately anyway to provide a methoud of disabling all FPGA outputs during software testing anyway. | Hack was to cut trace on PIN_40 and jumper PMOD pin to PIN_9 instead.  PIN_40 was set as input with weak pul-up just in case. |
